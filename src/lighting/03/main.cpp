...
// lighting
glm::vec3 lightPos(0.82f, 0.80f, 0.80f);
...
int main()
{
    ...
    // ------------------------------------
    Shader materialsShader("materials.vs", "materials.fs"); 
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        materialsShader.setVec3("objectColor", {1.0f, 0.5f, 0.31f});
        materialsShader.setVec3("lightColor", {1.0f, 1.0f, 1.0f});
        materialsShader.setVec3("lightPos", lightPos);
        ...
        materialsShader.setVec3("light.ambient", ambientColor);
        materialsShader.setVec3("light.diffuse", diffuseColor);
