...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 光衰减
        materialsShader.setFloat("light.constant",  1.0f);
        materialsShader.setFloat("light.linear",    0.09f);
        materialsShader.setFloat("light.quadratic", 0.032f);
        // 聚光
        materialsShader.setVec3("light.position",  camera.Position);
        materialsShader.setVec3("light.direction", camera.Front);
        materialsShader.setFloat("light.cutOff",   glm::cos(glm::radians(12.5f)));   
